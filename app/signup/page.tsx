...
import { Mail, Lock, Building2, Sparkles, User, Briefcase } from 'lucide-react'
      ...
      <Card className="relative w-full max-w-md backdrop-blur-xl bg-slate-900/70 border-slate-800/50 shadow-2xl shadow-purple-500/20">
        ...
        <form onSubmit={handleSignup}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <label htmlFor="department" className="text-sm font-medium text-slate-300 flex items-center gap-2">
              ...
              <Select
                ...
                disabled={loading}
              >
                <SelectTrigger className="bg-slate-950/50 border-slate-700 text-white focus:border-pink-400 focus:ring-pink-400/20">
                  <SelectValue placeholder="Departman seçin" className="text-slate-500" />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-slate-950/50 border-slate-700 text-white placeholder:text-slate-500 focus:border-cyan-400 focus:ring-cyan-400/20"
              />
              <p className="text-xs text-slate-500">Minimum 6 karakter</p>
            </div>
          </CardContent>
